...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Waveform_PC.png} 
    \caption{Waveform of PC testbench}
\end{figure}
\newpage
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Waveform_ALU.png} 
    \caption{Waveform of ALU testbench}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Waveform_Controller.png} 
    \caption{Waveform of Controller testbench}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Waveform_CPU.png} 
    \caption{Waveform of CPU testbench}
\end{figure}
\newpage
