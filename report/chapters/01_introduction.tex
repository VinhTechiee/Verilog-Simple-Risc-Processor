...
The designed CPU supports a small but representative set of instructions. Since the opcode field is 3 bits wide, the CPU can define up to eight instructions. These instructions include program control, arithmetic operations, logic operations, memory access, and conditional execution.
