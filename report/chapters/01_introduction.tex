...
Section~\ref{sec:system_design_approach} describes the design of the CPU. This section presents the overall system architecture, block diagram, and detailed functions of each hardware module.
