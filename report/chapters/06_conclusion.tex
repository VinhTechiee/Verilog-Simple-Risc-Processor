...
\hline
1 & Trần Vinh Quang & 2550342 
& Implemented the Controller module, including the finite state machine and control signal generation. Contributed to the project report. \\
\hline
2 & Lê Hiển Vinh & 2453422 
& Implemented the Program Counter and top-level CPU modules. Developed the testbenches and expected output files, and performed simulation verification for the system. \\
\hline
3 & Nguyễn Đức Thiên Tân & 2550345 
& Implemented the Memory and Instruction Register modules, including memory access logic and instruction decoding. Contributed to the project report. \\
\hline
4 & Đặng Ngọc Lan Anh & 2550258 
& Implemented the ALU and Accumulator modules, including arithmetic, logic, zero-flag, and register operations. Contributed to the project report. \\
\hline
\end{tabular}
\end{table}