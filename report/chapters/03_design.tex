...
\begin{itemize}
	\item \textbf{Function:}
	      \begin{itemize}
		      ...
		      \item The counter has a width of 32 bits.
...
\begin{itemize}
	\item \textbf{Function:}
	      \begin{itemize}
		      ...
		      \item The MUX has a default data width of 32 bits.
...
\begin{itemize}
	\item \textbf{Function:}
	      \begin{itemize}
		      ...
		      \item The ALU executes 8 distinct operations on 32-bit operands (\texttt{inA} and \texttt{inB}).
		      \item It produces a 32-bit output and a 1-bit asynchronous \texttt{zero} flag.
...
\begin{itemize}
	\item \textbf{Function:}
	      \begin{itemize}
		      ...
		      \item Configured for 32-bit addresses and 32-bit data.
